 ...
 * @fmt: For formatted string in which to print the arguments.
 * @list: For listing of arguments to be printed.
 * @ind: Pointer to an integer variable
 * @buffer: For buffer array to handle print.
 * @flags: For active flags calcilation
 * @width: for width.
