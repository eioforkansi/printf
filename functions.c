 ...
 * @types: For the list a of arguments
 ...
 * Return: For the number of characters printed
 */
 ...
 * @types: For the list a of arguments
 * @buffer: For the buffer array to handle print
 * @flags:  For calculation of active flags
 * @width: For the width.
 ...
 * @buffer: For the buffer array to handle print
 * @flags:  For the calculation of the active flags
 * @width: For the width.
 * @precision: For the precision specification
 * @size: For the size specifier
